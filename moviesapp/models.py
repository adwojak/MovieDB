...
class MovieModel(Model):
    ...
    genre = CharField(max_length=200, blank=True)
    director = CharField(max_length=200, blank=True)
    writer = CharField(max_length=200, blank=True)
    actors = CharField(max_length=300, blank=True)
    plot = CharField(max_length=500, blank=True)
    ...
    production = CharField(max_length=200, blank=True)
    website = CharField(max_length=200, blank=True)
